...
from all_utils.nn import update_ema
from all_utils.resample import LossAwareSampler, UniformSampler
...
class TrainLoop:
    def __init__(
        ...
        *,
        ...
        self.step = 0
        self.resume_step = 0
        self.global_batch = self.batch_size * 1.0
    ...
    def run_loop(self):
        while (
            ...
            batch, cond = next(self.data) # batch: batch_N * max_length * hidden_size, cond['input_ids']: batch_N * max_length
